...
todoListCont.addEventListener("click", function (event) {
    ...
    if (!isMenuVisible) {
        todoContainer.style.animation = "todoScaleIn 300ms cubic-bezier(0.2, 0, 0, 1) forwards";
        todoListCont.classList.add("menu-open"); // Hide tooltip
        todoInput.focus(); // Auto focus on input box
    } else {
        //todoContainer.style.animation = "todoScaleOut 150ms cubic-bezier(0.4, 0, 1, 1) forwards";

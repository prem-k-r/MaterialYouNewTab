...
const ru = {
    ...
    "todoCategoryAll": "Все",
    "todoCategoryUncategorized": "Без категории",
    "todoCategoryWork": "Работа",
    "todoCategoryLife": "Жизнь",
    "todoCategoryStudy": "Учёба",
    "todoCategoryOther": "Другое",
    "todoPriorityHigh": "Высокий",
    "todoPriorityMedium": "Средний",
    "todoPriorityLow": "Низкий",
    "todoFilterAll": "Все",
    "todoFilterPending": "В ожидании",
    "todoFilterCompleted": "Выполнено",
    "todoFilterOverdue": "Просрочено",
    "todoFilterToday": "Сегодня",
    "todoSortCreated": "Создано",
    "todoSortPriority": "Приоритет",
    "todoSortDue": "Срок",
    "todoImportSuccess": "Импорт успешен!",
    "todoImportFailed": "Ошибка импорта: неверный JSON файл",
    "todoDueOverdue": "Просрочено",
    "todoDueToday": "Срок сегодня",
    "todoNotificationTitle": "Напоминание о задачах",
    "todoContextMenuAdd": "Добавить в список",
    "importText": "Импорт",
    "exportText": "Экспорт",

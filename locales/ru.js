...
const ru = {
    ...
    "cloudBackupSectionTitle": "Облачное резервное копирование",
    "webdavTitle": "Синхронизация WebDAV",
    "webdavBackupText": "Сохранить в WebDAV",
    "webdavRestoreText": "Восстановить последнее",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "Имя пользователя (необязательно)",
    "webdavPasswordPlaceholder": "Пароль или пароль приложения (необязательно)",
    "cloudAutoBackupText": "Включить автоматическое резервное копирование",
    "cloudIntervalPlaceholder": "Часы",
    "cloudIntervalHours": "Часы",
    "saveBackupConfig": "Сохранить настройки резервного копирования",
    "backupConfigSaved": "Настройки резервного копирования сохранены.",
    "webdavMissingConfig": "Сначала заполните URL папки WebDAV.",
    "webdavPermissionDenied": "Для этого сервера WebDAV не выдано разрешение хоста.",
    "webdavBackupCompleted": "Резервная копия успешно загружена в WebDAV!",
    "webdavDownloadFailed": "Не удалось скачать резервную копию из WebDAV: ",
    "webdavUploadFailed": "Не удалось загрузить резервную копию в WebDAV: ",
    "webdavRestoreConfirm": "Восстановить настройки из последней резервной копии WebDAV? Текущие локальные данные будут перезаписаны.",
    "webdavLatestPointerMissing": "В папке MYNT не найдена запись о последней резервной копии."
};

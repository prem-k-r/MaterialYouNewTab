...
const sl = {
    ...
    "cloudBackupSectionTitle": "Varnostna kopija v oblaku",
    "webdavTitle": "Sinhronizacija WebDAV",
    "webdavBackupText": "Varnostno kopiraj v WebDAV",
    "webdavRestoreText": "Obnovi najnovejše",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "Uporabniško ime (neobvezno)",
    "webdavPasswordPlaceholder": "Geslo ali geslo aplikacije (neobvezno)",
    "cloudAutoBackupText": "Omogoči samodejno varnostno kopiranje",
    "cloudIntervalPlaceholder": "Ure",
    "cloudIntervalHours": "Ure",
    "saveBackupConfig": "Shrani nastavitve varnostne kopije",
    "backupConfigSaved": "Nastavitve varnostne kopije so shranjene.",
    "webdavMissingConfig": "Najprej izpolnite URL mape WebDAV.",
    "webdavPermissionDenied": "Dovoljenje gostitelja za ta strežnik WebDAV ni bilo odobreno.",
    "webdavBackupCompleted": "Varnostna kopija je bila uspešno naložena v WebDAV!",
    "webdavDownloadFailed": "Prenos varnostne kopije iz WebDAV ni uspel: ",
    "webdavUploadFailed": "Nalaganje varnostne kopije v WebDAV ni uspelo: ",
    "webdavRestoreConfirm": "Obnoviti nastavitve iz najnovejše varnostne kopije WebDAV? Trenutni lokalni podatki bodo prepisani.",
    "webdavLatestPointerMissing": "V mapi MYNT ni bilo najdene evidence o najnovejši varnostni kopiji."
};

...
const zh_TW = {
    ...
    "cloudBackupSectionTitle": "雲端備份",
    "webdavTitle": "WebDAV 同步",
    "webdavBackupText": "備份到 WebDAV",
    "webdavRestoreText": "還原最新備份",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "使用者名稱（選填）",
    "webdavPasswordPlaceholder": "密碼或應用程式密碼（選填）",
    "cloudAutoBackupText": "啟用自動備份",
    "cloudIntervalPlaceholder": "小時",
    "cloudIntervalHours": "小時",
    "saveBackupConfig": "儲存備份設定",
    "backupConfigSaved": "備份設定已儲存。",
    "webdavMissingConfig": "請先填寫 WebDAV 資料夾 URL。",
    "webdavPermissionDenied": "尚未授予此 WebDAV 伺服器的主機權限。",
    "webdavBackupCompleted": "已成功上傳備份到 WebDAV！",
    "webdavDownloadFailed": "從 WebDAV 下載備份失敗：",
    "webdavUploadFailed": "上傳備份到 WebDAV 失敗：",
    "webdavRestoreConfirm": "要從最新的 WebDAV 備份還原設定嗎？目前的本機資料將會被覆寫。",
    "webdavLatestPointerMissing": "在 MYNT 資料夾中找不到最新備份記錄。"
};
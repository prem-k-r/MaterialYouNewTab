...
const uk = {
    ...
    "cloudBackupSectionTitle": "Хмарне резервне копіювання",
    "webdavTitle": "Синхронізація WebDAV",
    "webdavBackupText": "Зберегти у WebDAV",
    "webdavRestoreText": "Відновити останню",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "Ім’я користувача (необов’язково)",
    "webdavPasswordPlaceholder": "Пароль або пароль застосунку (необов’язково)",
    "cloudAutoBackupText": "Увімкнути автоматичне резервне копіювання",
    "cloudIntervalPlaceholder": "Години",
    "cloudIntervalHours": "Години",
    "saveBackupConfig": "Зберегти налаштування резервного копіювання",
    "backupConfigSaved": "Налаштування резервного копіювання збережено.",
    "webdavMissingConfig": "Спочатку заповніть URL папки WebDAV.",
    "webdavPermissionDenied": "Для цього сервера WebDAV не надано дозвіл хоста.",
    "webdavBackupCompleted": "Резервну копію успішно завантажено до WebDAV!",
    "webdavDownloadFailed": "Не вдалося завантажити резервну копію з WebDAV: ",
    "webdavUploadFailed": "Не вдалося завантажити резервну копію до WebDAV: ",
    "webdavRestoreConfirm": "Відновити налаштування з останньої резервної копії WebDAV? Поточні локальні дані буде перезаписано.",
    "webdavLatestPointerMissing": "У папці MYNT не знайдено запису про останню резервну копію."
};

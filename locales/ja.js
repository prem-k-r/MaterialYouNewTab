...
const ja = {
    ...
    "cloudBackupSectionTitle": "クラウドバックアップ",
    "webdavTitle": "WebDAV 同期",
    "webdavBackupText": "WebDAV にバックアップ",
    "webdavRestoreText": "最新を復元",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "ユーザー名（任意）",
    "webdavPasswordPlaceholder": "パスワードまたはアプリパスワード（任意）",
    "cloudAutoBackupText": "自動バックアップを有効にする",
    "cloudIntervalPlaceholder": "時間",
    "cloudIntervalHours": "時間",
    "saveBackupConfig": "バックアップ設定を保存",
    "backupConfigSaved": "バックアップ設定を保存しました。",
    "webdavMissingConfig": "最初に WebDAV フォルダーの URL を入力してください。",
    "webdavPermissionDenied": "この WebDAV サーバーのホスト権限が付与されていません。",
    "webdavBackupCompleted": "バックアップを WebDAV に正常にアップロードしました。",
    "webdavDownloadFailed": "WebDAV からバックアップをダウンロードできませんでした: ",
    "webdavUploadFailed": "WebDAV へのバックアップのアップロードに失敗しました: ",
    "webdavRestoreConfirm": "最新の WebDAV バックアップから設定を復元しますか？現在のローカルデータは上書きされます。",
    "webdavLatestPointerMissing": "MYNT フォルダーに最新バックアップの記録が見つかりませんでした。"
};

...
const it = {
    ...
    "cloudBackupSectionTitle": "Backup cloud",
    "webdavTitle": "Sincronizzazione WebDAV",
    "webdavBackupText": "Esegui backup su WebDAV",
    "webdavRestoreText": "Ripristina il più recente",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "Nome utente (opzionale)",
    "webdavPasswordPlaceholder": "Password o password app (opzionale)",
    "cloudAutoBackupText": "Attiva backup automatico",
    "cloudIntervalPlaceholder": "Ore",
    "cloudIntervalHours": "Ore",
    "saveBackupConfig": "Salva configurazione backup",
    "backupConfigSaved": "Configurazione backup salvata.",
    "webdavMissingConfig": "Compila prima l'URL della cartella WebDAV.",
    "webdavPermissionDenied": "L'autorizzazione host non è stata concessa per questo server WebDAV.",
    "webdavBackupCompleted": "Backup caricato su WebDAV con successo!",
    "webdavDownloadFailed": "Download del backup da WebDAV non riuscito: ",
    "webdavUploadFailed": "Caricamento del backup su WebDAV non riuscito: ",
    "webdavRestoreConfirm": "Ripristinare le impostazioni dal backup WebDAV più recente? I dati locali correnti verranno sovrascritti.",
    "webdavLatestPointerMissing": "Nessun record del backup più recente trovato nella cartella MYNT."
};

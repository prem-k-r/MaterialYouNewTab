...
const ko = {
    ...
    "cloudBackupSectionTitle": "클라우드 백업",
    "webdavTitle": "WebDAV 동기화",
    "webdavBackupText": "WebDAV에 백업",
    "webdavRestoreText": "최신 백업 복원",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "사용자 이름(선택 사항)",
    "webdavPasswordPlaceholder": "비밀번호 또는 앱 비밀번호(선택 사항)",
    "cloudAutoBackupText": "자동 백업 사용",
    "cloudIntervalPlaceholder": "시간",
    "cloudIntervalHours": "시간",
    "saveBackupConfig": "백업 설정 저장",
    "backupConfigSaved": "백업 설정이 저장되었습니다.",
    "webdavMissingConfig": "먼저 WebDAV 폴더 URL을 입력하세요.",
    "webdavPermissionDenied": "이 WebDAV 서버에 대한 호스트 권한이 부여되지 않았습니다.",
    "webdavBackupCompleted": "백업이 WebDAV에 성공적으로 업로드되었습니다!",
    "webdavDownloadFailed": "WebDAV에서 백업을 다운로드하지 못했습니다: ",
    "webdavUploadFailed": "WebDAV에 백업을 업로드하지 못했습니다: ",
    "webdavRestoreConfirm": "가장 최근 WebDAV 백업에서 설정을 복원하시겠습니까? 현재 로컬 데이터가 덮어써집니다.",
    "webdavLatestPointerMissing": "MYNT 폴더에서 최신 백업 기록을 찾을 수 없습니다."
};

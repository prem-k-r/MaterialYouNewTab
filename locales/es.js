...
const es = {
    ...
    "cloudBackupSectionTitle": "Copia en la nube",
    "webdavTitle": "Sincronización WebDAV",
    "webdavBackupText": "Respaldar en WebDAV",
    "webdavRestoreText": "Restaurar el más reciente",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "Nombre de usuario (opcional)",
    "webdavPasswordPlaceholder": "Contraseña o contraseña de aplicación (opcional)",
    "cloudAutoBackupText": "Activar copia automática",
    "cloudIntervalPlaceholder": "Horas",
    "cloudIntervalHours": "Horas",
    "saveBackupConfig": "Guardar configuración de copia",
    "backupConfigSaved": "Configuración de copia guardada.",
    "webdavMissingConfig": "Completa primero la URL de la carpeta WebDAV.",
    "webdavPermissionDenied": "No se concedió permiso de host para este servidor WebDAV.",
    "webdavBackupCompleted": "¡Copia subida a WebDAV correctamente!",
    "webdavDownloadFailed": "Error al descargar la copia desde WebDAV: ",
    "webdavUploadFailed": "Error al subir la copia a WebDAV: ",
    "webdavRestoreConfirm": "¿Restaurar la configuración desde la copia WebDAV más reciente? Tus datos locales actuales se sobrescribirán.",
    "webdavLatestPointerMissing": "No se encontró un registro de la copia más reciente en la carpeta MYNT."
};

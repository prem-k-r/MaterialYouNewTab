...
const pl = {
    ...
    "cloudBackupSectionTitle": "Kopia w chmurze",
    "webdavTitle": "Synchronizacja WebDAV",
    "webdavBackupText": "Utwórz kopię w WebDAV",
    ...
    "webdavUsernamePlaceholder": "Nazwa użytkownika (opcjonalnie)",
    "webdavPasswordPlaceholder": "Hasło lub hasło aplikacji (opcjonalnie)",
    "cloudAutoBackupText": "Włącz automatyczne kopie",
    "cloudIntervalPlaceholder": "Godziny",
    "cloudIntervalHours": "Godziny",
    "saveBackupConfig": "Zapisz konfigurację kopii",
    "backupConfigSaved": "Konfiguracja kopii została zapisana.",
    "webdavMissingConfig": "Najpierw uzupełnij adres URL folderu WebDAV.",
    "webdavPermissionDenied": "Nie przyznano uprawnienia hosta dla tego serwera WebDAV.",
    "webdavBackupCompleted": "Kopia została pomyślnie wysłana do WebDAV!",
    "webdavDownloadFailed": "Nie udało się pobrać kopii z WebDAV: ",
    "webdavUploadFailed": "Nie udało się wysłać kopii do WebDAV: ",
    "webdavRestoreConfirm": "Przywrócić ustawienia z najnowszej kopii WebDAV? Obecne lokalne dane zostaną nadpisane.",
    "webdavLatestPointerMissing": "Nie znaleziono wpisu najnowszej kopii w folderze MYNT."
};

...
const fr = {
    ...
    "cloudBackupSectionTitle": "Sauvegarde cloud",
    "webdavTitle": "Synchronisation WebDAV",
    "webdavBackupText": "Sauvegarder sur WebDAV",
    "webdavRestoreText": "Restaurer la plus récente",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "Nom d'utilisateur (optionnel)",
    "webdavPasswordPlaceholder": "Mot de passe ou mot de passe d’application (optionnel)",
    "cloudAutoBackupText": "Activer la sauvegarde automatique",
    "cloudIntervalPlaceholder": "Heures",
    "cloudIntervalHours": "Heures",
    "saveBackupConfig": "Enregistrer la configuration de sauvegarde",
    "backupConfigSaved": "Configuration de sauvegarde enregistrée.",
    "webdavMissingConfig": "Veuillez d’abord remplir l’URL du dossier WebDAV.",
    "webdavPermissionDenied": "L’autorisation d’hôte n’a pas été accordée pour ce serveur WebDAV.",
    "webdavBackupCompleted": "Sauvegarde envoyée vers WebDAV avec succès !",
    "webdavDownloadFailed": "Échec du téléchargement depuis WebDAV : ",
    "webdavUploadFailed": "Échec de l’envoi vers WebDAV : ",
    "webdavRestoreConfirm": "Restaurer les paramètres depuis la sauvegarde WebDAV la plus récente ? Vos données locales actuelles seront écrasées.",
    "webdavLatestPointerMissing": "Aucune trace de la sauvegarde la plus récente n’a été trouvée dans le dossier MYNT."
};

...
const idn = {
    ...
    "cloudBackupSectionTitle": "Cadangan cloud",
    "webdavTitle": "Sinkronisasi WebDAV",
    "webdavBackupText": "Cadangkan ke WebDAV",
    "webdavRestoreText": "Pulihkan yang terbaru",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "Nama pengguna (opsional)",
    "webdavPasswordPlaceholder": "Kata sandi atau kata sandi aplikasi (opsional)",
    "cloudAutoBackupText": "Aktifkan cadangan otomatis",
    "cloudIntervalPlaceholder": "Jam",
    "cloudIntervalHours": "Jam",
    "saveBackupConfig": "Simpan konfigurasi cadangan",
    "backupConfigSaved": "Konfigurasi cadangan disimpan.",
    "webdavMissingConfig": "Isi URL folder WebDAV terlebih dahulu.",
    "webdavPermissionDenied": "Izin host belum diberikan untuk server WebDAV ini.",
    "webdavBackupCompleted": "Cadangan berhasil diunggah ke WebDAV!",
    "webdavDownloadFailed": "Gagal mengunduh cadangan dari WebDAV: ",
    "webdavUploadFailed": "Gagal mengunggah cadangan ke WebDAV: ",
    "webdavRestoreConfirm": "Pulihkan pengaturan dari cadangan WebDAV terbaru? Data lokal Anda saat ini akan ditimpa.",
    "webdavLatestPointerMissing": "Catatan cadangan terbaru tidak ditemukan di folder MYNT."
};

...
const zh = {
    ...
    "cloudBackupSectionTitle": "云备份",
    "webdavTitle": "WebDAV 同步",
    "webdavBackupText": "备份到 WebDAV",
    "webdavRestoreText": "恢复最新备份",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "用户名（可选）",
    "webdavPasswordPlaceholder": "密码或应用专用密码（可选）",
    "cloudAutoBackupText": "启用自动备份",
    "cloudIntervalPlaceholder": "小时",
    "cloudIntervalHours": "小时",
    "saveBackupConfig": "保存备份配置",
    "backupConfigSaved": "备份配置已保存。",
    "webdavMissingConfig": "请先填写 WebDAV 文件夹 URL。",
    "webdavPermissionDenied": "未授予此 WebDAV 服务器的主机权限。",
    "webdavBackupCompleted": "已成功上传备份到 WebDAV！",
    "webdavDownloadFailed": "从 WebDAV 下载备份失败：",
    "webdavUploadFailed": "上传备份到 WebDAV 失败：",
    "webdavRestoreConfirm": "要从最新的 WebDAV 备份恢复设置吗？当前本地数据将被覆盖。",
    "webdavLatestPointerMissing": "在 MYNT 文件夹中没有找到最新备份记录。"
};
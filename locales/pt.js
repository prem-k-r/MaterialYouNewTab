...
const pt = {
    ...
    "cloudBackupSectionTitle": "Backup na nuvem",
    "webdavTitle": "Sincronização WebDAV",
    "webdavBackupText": "Fazer backup no WebDAV",
    "webdavRestoreText": "Restaurar backup mais recente",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "Nome de usuário (opcional)",
    "webdavPasswordPlaceholder": "Senha ou senha de app (opcional)",
    "cloudAutoBackupText": "Ativar backup automático",
    "cloudIntervalPlaceholder": "Horas",
    "cloudIntervalHours": "Horas",
    "saveBackupConfig": "Salvar configuração de backup",
    "backupConfigSaved": "Configuração de backup salva.",
    "webdavMissingConfig": "Preencha primeiro a URL da pasta WebDAV.",
    "webdavPermissionDenied": "A permissão de host não foi concedida para este servidor WebDAV.",
    "webdavBackupCompleted": "Backup enviado para o WebDAV com sucesso!",
    "webdavDownloadFailed": "Falha ao baixar o backup do WebDAV: ",
    "webdavUploadFailed": "Falha ao enviar o backup para o WebDAV: ",
    "webdavRestoreConfirm": "Restaurar as configurações do backup WebDAV mais recente? Seus dados locais atuais serão substituídos.",
    "webdavLatestPointerMissing": "Nenhum registro do backup mais recente foi encontrado na pasta MYNT."
};

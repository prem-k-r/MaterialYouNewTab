...
const hu = {
  ...
  "cloudBackupSectionTitle": "Felhőmentés",
  "webdavTitle": "WebDAV szinkronizálás",
  "webdavBackupText": "Mentés WebDAV-ra",
  "webdavRestoreText": "Legutóbbi visszaállítása",
  "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
  "cloudPrefixPlaceholder": "MYNT_Backup",
  "webdavUsernamePlaceholder": "Felhasználónév (opcionális)",
  "webdavPasswordPlaceholder": "Jelszó vagy alkalmazásjelszó (opcionális)",
  "cloudAutoBackupText": "Automatikus mentés engedélyezése",
  "cloudIntervalPlaceholder": "Óra",
  "cloudIntervalHours": "Óra",
  "saveBackupConfig": "Mentési beállítások mentése",
  "backupConfigSaved": "A mentési beállítások elmentve.",
  "webdavMissingConfig": "Először töltse ki a WebDAV mappa URL-jét.",
  "webdavPermissionDenied": "Ehhez a WebDAV szerverhez nem kapott hosztengedélyt.",
  "webdavBackupCompleted": "A mentés sikeresen feltöltve a WebDAV-ra!",
  "webdavDownloadFailed": "A mentés letöltése a WebDAV-ról nem sikerült: ",
  "webdavUploadFailed": "A mentés feltöltése a WebDAV-ra nem sikerült: ",
  "webdavRestoreConfirm": "Visszaállítja a beállításokat a legutóbbi WebDAV mentésből? A jelenlegi helyi adatok felülíródnak.",
  "webdavLatestPointerMissing": "Nem található a legutóbbi mentés bejegyzése a MYNT mappában."
};

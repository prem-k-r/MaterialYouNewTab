...
const el = {
    ...
    "todoCategoryAll": "Όλα",
    "todoCategoryUncategorized": "Χωρίς κατηγορία",
    "todoCategoryWork": "Εργασία",
    "todoCategoryLife": "Ζωή",
    "todoCategoryStudy": "Σπουδές",
    "todoCategoryOther": "Άλλο",
    "todoPriorityHigh": "Υψηλή",
    "todoPriorityMedium": "Μεσαία",
    "todoPriorityLow": "Χαμηλή",
    "todoFilterAll": "Όλα",
    "todoFilterPending": "Εκκρεμή",
    "todoFilterCompleted": "Ολοκληρωμένα",
    "todoFilterOverdue": "Εκπρόθεσμα",
    "todoFilterToday": "Σήμερα",
    "todoSortCreated": "Δημιουργήθηκε",
    "todoSortPriority": "Προτεραιότητα",
    "todoSortDue": "Προθεσμία",
    "todoImportSuccess": "Η εισαγωγή ήταν επιτυχής!",
    "todoImportFailed": "Αποτυχία εισαγωγής: Μη έγκυρο αρχείο JSON",
    "todoDueOverdue": "Εκπρόθεσμο",
    "todoDueToday": "Λήγει σήμερα",
    "todoNotificationTitle": "Υπενθύμιση εργασιών",
    "todoContextMenuAdd": "Προσθήκη στη λίστα",
    "importText": "Εισαγωγή",
    "exportText": "Εξαγωγή",

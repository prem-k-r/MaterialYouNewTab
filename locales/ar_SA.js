...
const ar_SA = {
    ...
    todoCategoryAll: "الكل",
    todoCategoryUncategorized: "غير مصنف",
    todoCategoryWork: "عمل",
    todoCategoryLife: "حياة",
    todoCategoryStudy: "دراسة",
    todoCategoryOther: "أخرى",
    todoPriorityHigh: "عالي",
    todoPriorityMedium: "متوسط",
    todoPriorityLow: "منخفض",
    todoFilterAll: "الكل",
    todoFilterPending: "معلق",
    todoFilterCompleted: "مكتمل",
    todoFilterOverdue: "متأخر",
    todoFilterToday: "اليوم",
    todoSortCreated: "تاريخ الإنشاء",
    todoSortPriority: "الأولوية",
    todoSortDue: "الموعد",
    todoImportSuccess: "نجح الاستيراد!",
    todoImportFailed: "فشل الاستيراد: ملف JSON غير صالح",
    todoDueOverdue: "متأخر",
    todoDueToday: "موعد اليوم",
    todoNotificationTitle: "تذكير بالمهام",
    todoContextMenuAdd: "إضافة للقائمة",
    importText: "استيراد",
    exportText: "تصدير",

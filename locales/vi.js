...
const vi = {
    ...
    "todoCategoryAll": "Tất cả",
    "todoCategoryUncategorized": "Chưa phân loại",
    "todoCategoryWork": "Công việc",
    "todoCategoryLife": "Cuộc sống",
    "todoCategoryStudy": "Học tập",
    "todoCategoryOther": "Khác",
    "todoPriorityHigh": "Cao",
    "todoPriorityMedium": "Trung bình",
    "todoPriorityLow": "Thấp",
    "todoFilterAll": "Tất cả",
    "todoFilterPending": "Chưa xong",
    "todoFilterCompleted": "Đã xong",
    "todoFilterOverdue": "Quá hạn",
    "todoFilterToday": "Hôm nay",
    "todoSortCreated": "Ngày tạo",
    "todoSortPriority": "Độ ưu tiên",
    "todoSortDue": "Hạn chót",
    "todoImportSuccess": "Nhập thành công!",
    "todoImportFailed": "Nhập thất bại: Tệp JSON không hợp lệ",
    "todoDueOverdue": "Quá hạn",
    "todoDueToday": "Hết hạn hôm nay",
    "todoNotificationTitle": "Nhắc nhở việc cần làm",
    "todoContextMenuAdd": "Thêm vào danh sách",
    "importText": "Nhập",
    "exportText": "Xuất",

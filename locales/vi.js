...
const vi = {
    ...
    "cloudBackupSectionTitle": "Sao lưu đám mây",
    "webdavTitle": "Đồng bộ WebDAV",
    "webdavBackupText": "Sao lưu lên WebDAV",
    "webdavRestoreText": "Khôi phục bản mới nhất",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "Tên người dùng (tùy chọn)",
    "webdavPasswordPlaceholder": "Mật khẩu hoặc mật khẩu ứng dụng (tùy chọn)",
    "cloudAutoBackupText": "Bật sao lưu tự động",
    "cloudIntervalPlaceholder": "Giờ",
    "cloudIntervalHours": "Giờ",
    "saveBackupConfig": "Lưu cấu hình sao lưu",
    "backupConfigSaved": "Đã lưu cấu hình sao lưu.",
    "webdavMissingConfig": "Vui lòng nhập URL thư mục WebDAV trước.",
    "webdavPermissionDenied": "Chưa được cấp quyền host cho máy chủ WebDAV này.",
    "webdavBackupCompleted": "Đã tải bản sao lưu lên WebDAV thành công!",
    "webdavDownloadFailed": "Không thể tải bản sao lưu từ WebDAV: ",
    "webdavUploadFailed": "Không thể tải bản sao lưu lên WebDAV: ",
    "webdavRestoreConfirm": "Khôi phục cài đặt từ bản sao lưu WebDAV mới nhất? Dữ liệu cục bộ hiện tại sẽ bị ghi đè.",
    "webdavLatestPointerMissing": "Không tìm thấy bản ghi của bản sao lưu mới nhất trong thư mục MYNT."
};

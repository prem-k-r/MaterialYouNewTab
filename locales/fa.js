...
const fa = {
    ...
    "cloudBackupSectionTitle": "پشتیبان‌گیری ابری",
    "webdavTitle": "همگام‌سازی WebDAV",
    "webdavBackupText": "پشتیبان‌گیری در WebDAV",
    "webdavRestoreText": "بازیابی آخرین نسخه",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "نام کاربری (اختیاری)",
    "webdavPasswordPlaceholder": "رمز عبور یا رمز عبور برنامه (اختیاری)",
    "cloudAutoBackupText": "فعال‌سازی پشتیبان‌گیری خودکار",
    "cloudIntervalPlaceholder": "ساعت",
    "cloudIntervalHours": "ساعت",
    "saveBackupConfig": "ذخیره تنظیمات پشتیبان",
    "backupConfigSaved": "تنظیمات پشتیبان ذخیره شد.",
    "webdavMissingConfig": "ابتدا URL پوشه WebDAV را وارد کنید.",
    "webdavPermissionDenied": "مجوز میزبان برای این سرور WebDAV داده نشده است.",
    "webdavBackupCompleted": "پشتیبان با موفقیت در WebDAV بارگذاری شد!",
    "webdavDownloadFailed": "دانلود پشتیبان از WebDAV ناموفق بود: ",
    "webdavUploadFailed": "بارگذاری پشتیبان در WebDAV ناموفق بود: ",
    "webdavRestoreConfirm": "تنظیمات از جدیدترین پشتیبان WebDAV بازیابی شود؟ داده‌های محلی فعلی شما بازنویسی می‌شوند.",
    "webdavLatestPointerMissing": "رکورد جدیدترین پشتیبان در پوشه MYNT پیدا نشد."
};

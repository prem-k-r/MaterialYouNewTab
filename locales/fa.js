...
const fa = {
    ...
    todoCategoryAll: "همه",
    todoCategoryUncategorized: "بدون دسته",
    todoCategoryWork: "کار",
    todoCategoryLife: "زندگی",
    todoCategoryStudy: "تحصیل",
    todoCategoryOther: "دیگر",
    todoPriorityHigh: "بالا",
    todoPriorityMedium: "متوسط",
    todoPriorityLow: "پایین",
    todoFilterAll: "همه",
    todoFilterPending: "در انتظار",
    todoFilterCompleted: "انجام شده",
    todoFilterOverdue: "منقضی شده",
    todoFilterToday: "امروز",
    todoSortCreated: "ایجاد شده",
    todoSortPriority: "اولویت",
    todoSortDue: "موعد",
    todoImportSuccess: "ورود موفق!",
    todoImportFailed: "خطای ورود: فایل JSON نامعتبر",
    todoDueOverdue: "منقضی شده",
    todoDueToday: "موعد امروز",
    todoNotificationTitle: "یادآوری کار",
    todoContextMenuAdd: "افزودن به لیست",
    importText: "ورود",
    exportText: "خروج",

...
const th = {
    ...
    "webdavTitle": "ซิงก์ WebDAV",
    "webdavBackupText": "สำรองไปยัง WebDAV",
    "webdavRestoreText": "กู้คืนล่าสุด",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "ชื่อผู้ใช้ (ไม่บังคับ)",
    "webdavPasswordPlaceholder": "รหัสผ่านหรือรหัสผ่านแอป (ไม่บังคับ)",
    "cloudAutoBackupText": "เปิดใช้การสำรองข้อมูลอัตโนมัติ",
    "cloudIntervalPlaceholder": "ชั่วโมง",
    "cloudIntervalHours": "ชั่วโมง",
    "saveBackupConfig": "บันทึกการตั้งค่าการสำรองข้อมูล",
    "backupConfigSaved": "บันทึกการตั้งค่าการสำรองข้อมูลแล้ว",
    "webdavMissingConfig": "กรุณากรอก URL โฟลเดอร์ WebDAV ก่อน",
    "webdavPermissionDenied": "ยังไม่ได้รับสิทธิ์โฮสต์สำหรับเซิร์ฟเวอร์ WebDAV นี้",
    "webdavBackupCompleted": "อัปโหลดข้อมูลสำรองไปยัง WebDAV สำเร็จ!",
    "webdavDownloadFailed": "ดาวน์โหลดข้อมูลสำรองจาก WebDAV ไม่สำเร็จ: ",
    "webdavUploadFailed": "อัปโหลดข้อมูลสำรองไปยัง WebDAV ไม่สำเร็จ: ",
    "webdavRestoreConfirm": "กู้คืนการตั้งค่าจากข้อมูลสำรอง WebDAV ล่าสุดหรือไม่? ข้อมูลภายในเครื่องปัจจุบันจะถูกเขียนทับ",
    "webdavLatestPointerMissing": "ไม่พบบันทึกข้อมูลสำรองล่าสุดในโฟลเดอร์ MYNT"
};

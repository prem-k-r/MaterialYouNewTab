...
const tr = {
    ...
    "cloudBackupSectionTitle": "Bulut yedekleme",
    "webdavTitle": "WebDAV senkronizasyonu",
    "webdavBackupText": "WebDAV'a yedekle",
    "webdavRestoreText": "En yeniyi geri yükle",
    "webdavUrlPlaceholder": "https://example.com/remote.php/dav/files/username/backups",
    "cloudPrefixPlaceholder": "MYNT_Backup",
    "webdavUsernamePlaceholder": "Kullanıcı adı (isteğe bağlı)",
    "webdavPasswordPlaceholder": "Parola veya uygulama parolası (isteğe bağlı)",
    "cloudAutoBackupText": "Otomatik yedeklemeyi etkinleştir",
    "cloudIntervalPlaceholder": "Saat",
    "cloudIntervalHours": "Saat",
    "saveBackupConfig": "Yedekleme yapılandırmasını kaydet",
    "backupConfigSaved": "Yedekleme yapılandırması kaydedildi.",
    "webdavMissingConfig": "Önce WebDAV klasörü URL'sini doldurun.",
    "webdavPermissionDenied": "Bu WebDAV sunucusu için host izni verilmedi.",
    "webdavBackupCompleted": "Yedek başarıyla WebDAV'a yüklendi!",
    "webdavDownloadFailed": "Yedek WebDAV'dan indirilemedi: ",
    "webdavUploadFailed": "Yedek WebDAV'a yüklenemedi: ",
    "webdavRestoreConfirm": "Ayarlar en son WebDAV yedeğinden geri yüklensin mi? Geçerli yerel verilerinizin üzerine yazılacak.",
    "webdavLatestPointerMissing": "MYNT klasöründe en son yedeğe ait kayıt bulunamadı."
};

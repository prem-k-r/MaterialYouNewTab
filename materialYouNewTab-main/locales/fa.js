...
const fa = {
    ...
    // Notes
    notesText: "یادداشت‌ها",
    notesInfo: "نمایش پنل یادداشت‌ها",
    notesHover: "یادداشت‌ها",
    deleteNotePrompt: "یادداشت «{title}» حذف شود؟ این عمل قابل بازگشت نیست.",
    notesContentPlaceholder: "چیزی بنویسید...",
    // Clock

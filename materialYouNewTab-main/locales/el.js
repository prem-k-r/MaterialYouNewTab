...
const el = {
    ...
    // Notes
    "notesText": "Σημειώσεις",
    "notesInfo": "Εμφάνιση πίνακα σημειώσεων",
    "notesHover": "Σημειώσεις",
    "deleteNotePrompt": "Διαγραφή σημείωσης \"{title}\"; Αυτό δεν μπορεί να αναιρεθεί.",
    "notesContentPlaceholder": "Γράψτε κάτι...",
    // Ρολόι

...
const ar_SA = {
    ...
    // Notes
    notesText: "الملاحظات",
    notesInfo: "إظهار لوحة الملاحظات",
    notesHover: "الملاحظات",
    deleteNotePrompt: "حذف الملاحظة \"{title}\"؟ لا يمكن التراجع عن هذا الإجراء.",
    notesContentPlaceholder: "اكتب شيئًا...",
    // Clock

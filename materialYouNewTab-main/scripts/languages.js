...
function applyLanguage(lang) {
    ...
    const elementsMap = [
        ...
        { id: "notesListHeading", key: "notesText" },
    ...
    // For Notes content editor placeholder
    const noteContentEditorEl = document.getElementById("noteContentEditor");
    if (noteContentEditorEl && translations[lang]) {
        noteContentEditorEl.dataset.placeholder =
            translations[lang]?.notesContentPlaceholder || translations["en"].notesContentPlaceholder;
    }
    ...
    const rtlSelectors = [".topDiv", ".searchbar", ".searchWithCont", ".resultBox", ".quotesCont",
        ...
        ".notes-container", "#noteEditorModal"]

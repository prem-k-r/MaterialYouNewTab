...
- Added Search by Image feature with support for image URL, file upload, and clipboard paste; routed through Google Lens regardless of the active search engine ([@M-Pasa](https://github.com/M-Pasa)) ([#202](https://github.com/prem-k-r/MaterialYouNewTab/pull/XXX))
